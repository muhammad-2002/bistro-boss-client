  ...
  return (
    <div>
      <div className="flex  gap-6 justify-center items-center">
        <p className="flex cursor-pointer justify-center border-2 border-[gray] rounded-full p-2 item">
          <svg
        ...
        <p
          ...
          className="flex cursor-pointer justify-center border-2 border-[gray] rounded-full p-2 item"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
