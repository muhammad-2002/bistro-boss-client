...
const Footer = () => {
  return (
    <div>
      <div className="flex justify-center flex-col md:flex-row items-center text-white mt-12 ">
        <div className="bg-[#1F2937] flex flex-col justify-center items-center h-[200px] w-full space-y-2">
        ...
        <div className="bg-[#131c31] h-[200px] flex flex-col justify-center items-center space-y-4 w-full">
      ...
      <div className="text-center bg-black px-8 text-white py-5">
